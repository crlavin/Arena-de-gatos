                            ...
                            <?php if (empty($lista_carrito)) : ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="1" max="99" step="1" value="<?php echo $cantidad; ?>" size="5" id="cantidad_<?php echo $_id; ?>" onchange="">
                                        </td>
                                        <td>$<?php echo number_format($total, 0, ',', '.'); ?></td>
                                        <td><button class="realizar-pago-btn" href="#" id="eliminar" data-bs-id="<?php echo $_id; ?>" data-bs-toggle="modal" data-bs-target="eliminaModal">Eliminar</button></td>
                                    </tr>
                            <?php endforeach;
                            endif; ?>
                            <tr>
                                <td colspan="3"></td>
                                <td colspan="2">
                                    <h3 id="total">$<?php echo number_format($total_general, 0, ',', '.'); ?> </h3>
                                </td>
                            </tr>
                        </tbody>
                    </table>
